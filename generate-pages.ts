...
import { seoPages, SEOPage } from 'C:/Users/gaming rig/Desktop/seo-content';
...
// ── HTML template ─────────────────────────────────────────────────────────────
function buildHTML(page: SEOPage): string {
...
${faqsHTML}
    ...
    ${page.relatedSlugs.length > 0 ? `<!-- Related pages -->
